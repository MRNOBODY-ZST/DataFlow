            ...
            <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 dark:bg-gray-800 dark:outline dark:-outline-offset-1 dark:outline-white/10">
              <div>
                <div class="mx-auto flex size-12 items-center justify-center rounded-full bg-indigo-100 dark:bg-indigo-500/10">
                  <Cog6ToothIcon class="size-6 text-indigo-600 dark:text-indigo-400" aria-hidden="true" />
                </div>
                  ...
                  <div v-if="isFieldVisible(field)" class="space-y-1.5">
                    ...
                    <div v-if="field.type === 'checkbox'" class="flex items-center gap-3">
                      <button
                        ...
                        class="relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
                        :class="localConfig[field.key] ? 'bg-indigo-600 dark:bg-indigo-500' : 'bg-gray-200 dark:bg-gray-600'"
                    ...
                    <div v-else-if="field.type === 'file-picker'" class="space-y-2">
                      ...
                      <input
                        ...
                        class="w-full rounded-md bg-white px-3 py-2 text-sm outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:focus:outline-indigo-500"
                      />
                    </div>
