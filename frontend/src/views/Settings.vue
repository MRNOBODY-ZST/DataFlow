    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-2xl">
        <div class="space-y-10">
          ...
          <div class="border-b border-gray-200 pb-10 dark:border-white/10">
            ...
            <dl class="mt-6 divide-y divide-gray-200 dark:divide-white/10">
              <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
                <dt class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ t('settings.username') }}</dt>
                <dd class="mt-1 text-sm text-gray-700 sm:col-span-2 sm:mt-0 dark:text-gray-300">{{ auth.username || '—' }}</dd>
              </div>
              <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
                <dt class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ t('settings.userId') }}</dt>
          ...
          <!-- API Section -->
          <div class="pb-10">
            <h2 class="text-base font-semibold text-gray-900 dark:text-white">{{ t('settings.api') }}</h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ t('settings.backendSettings') }}</p>

            <dl class="mt-6 divide-y divide-gray-200 dark:divide-white/10">
              <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
                <dt class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ t('settings.apiBaseUrl') }}</dt>
                <dd class="mt-1 text-sm text-gray-700 sm:col-span-2 sm:mt-0 dark:text-gray-300">/api</dd>
              </div>
              <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
                <dt class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ t('settings.authToken') }}</dt>
